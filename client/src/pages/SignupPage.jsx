  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8080/gardner/register",
        formPayload,
        {
              ...
              <div className="row">
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input
                    ...
                    type="text"
                    name="preferedcrops"
                    value={formData.preferedcrops}
                    onChange={handleChange}
                  />
                  {errors.preferedcrops && (
                    <small className="text-danger">
                      {errors.preferedcrops}
                    </small>
                  )}
                ...
                <div className="col-md-6 mb-3">
                  ...
                  />
                  {errors.profilePic && (
                    <small className="text-danger">{errors.profilePic}</small>
                  )}
                </div>
              </div>
